...
class MachineHistoryView(WorkshopRequiredMixin, View):
    ...
    GET parameters:
      machine_pk  — PK of the MachineAsset to inspect (optional).
    ...
    Parametros GET:
      machine_pk  — PK del MachineAsset a inspeccionar (opcional).
    ...
    def get(self, request, *args, **kwargs):
        ...
        # -- Parse GET params -----------------------------------------------
        machine_code_raw = request.GET.get("machine_code", "").strip().upper()
        ...
        # -- Machine queryset scoped to company — solo para resolver el pk
        # Machine queryset scoped to company — only used to resolve the pk
                ...
                enriched.append(
                    {
                        ...
                        "fault_category_display": _FAULT_CAT_MAP.get(
                            line.fault_category, line.fault_category or "—"
                        ),
