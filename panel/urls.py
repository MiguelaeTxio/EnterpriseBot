...
from panel.views_documentation import (
    ...
    MachinePageView,
    ObsoleteCandidateBulkDeleteView,
...
urlpatterns = [
    ...
    path("documentacion/obsoletos/eliminar-en-bloque/", ObsoleteCandidateBulkDeleteView.as_view(), name="documentation_obsolete_bulk_delete"),
