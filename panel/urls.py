...
urlpatterns = [
    ...
    path("documentacion/transferencia/<int:pk>/resolver/", DocumentDismissMismatchView.as_view(), name="documentation_document_dismiss_mismatch"),
